...
final class ChineseEchoAppDelegate: NSObject, NSApplicationDelegate, UNUserNotificationCenterDelegate {
...
@main
struct ChineseEchoApp: App {
    @NSApplicationDelegateAdaptor(ChineseEchoAppDelegate.self) private var appDelegate
